   ...
   <img src="libraryicon.jpg" id="aa"/>
       ...
       <div class="nav">
           <ul>
               ...
               <a class="current" href="Opera16.php"><li><i class="bi bi-check2-square"></i>Reserved</li></a>
...
<p id="mn">Do you want to reserve the selected book?</p>
<p id="ik">
    <input type="button" id="b1" name="b1" value="Yes" onclick="return reserve();"/>
